...
export type CaseStudy = {
  ...
  /** Downloadable write-up of the same run. Committed to public/docs/ and
   *  regenerated by scripts/gen-docking-report.py — keep the two in sync. */
  report?: { label: string; href: string; note?: string };
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "88 / 100",
        note: "Scored before docking: 2.90 Å resolution, 3 chains, 905 residues, zero missing residues.",
      },
      {
        label: "Poses generated",
        value: "2",
        note: "Full ensemble retained from the validation redock, not just the top hit.",
      },
    ],
    disclaimer: {
    ...
    report: {
      label: "Download the validation report (PDF)",
      href: "/docs/docking-validation-report.pdf",
      note: "3 pages · the full protocol, metrics, and limits — including the capture of the run.",
    },
    cta: {
